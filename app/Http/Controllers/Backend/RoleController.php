...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::all();
        $auth = Auth::user();
        return view('backend.roles.index',compact('roles','users','auth'));
    }
    ...
    public function store(Request $request)
    {
        ...
        notify()->success("Role Successfully Created","Added");
    ...
    public function destroy(Role $role)
    {
        ...
        {
            notify()->error("You can not delete this","Error","topLeft");
        }
        return back();
    }
}
