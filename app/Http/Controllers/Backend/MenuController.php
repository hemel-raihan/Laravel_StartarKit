...
class MenuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.menus.index',compact('menus','auth'));
    }
    ...
    public function store(Request $request)
    {
        ...
        notify()->success('successfully created Menu');
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        notify()->success('successfully updated Menu');
        return redirect()->route('app.menus.index');
    }
    ...
    public function destroy(Menu $menu)
    {
        ...
        {
            $menu->delete();
            notify()->success('successfully delete Menu');
            return redirect()->route('app.menus.index');
        }
        else
        {
            notify()->error('you have not to acces for delete');
        }
        return back();
    }
}
